...
const component = {
    E37S58: {
        ...
        upgrader: {work: 10, carry: 3, move: 8},
        ...
        miner: {work: 15, carry: 15, move: 15},
    ...
    E45S59: {
        ...
        upgrader: {work: 15, carry: 3, move: 8},
    ...
    E44S59: {
        ...
        worker: {work: 1, carry: 1, move: 1},
        transfer: {carry: 8, move: 4},
        upgrader: {work: 15,  move: 2, carry: 2},
        repairer: {work: 2, carry: 2, move: 2},
        builder: {work: 5, carry: 5, move: 5},
        outputer: {carry: 20, move: 10},
        harvest_linker: {work: 7, carry: 1, move: 1},
    ...
    E19S59: {
        ...
        outputer: {carry: 30, move: 15},
        controller: {claim: 1, move: 5},
        extender: {work: 5, move: 5, carry: 5},
        thief: {carry: 15, move: 15},
        wall_breaker: {work: 5, move: 5},
        miner: {work: 5, move: 5, carry: 5},
        center_transfer: {carry: 20, move: 1},
    ...
    E11S59: {
        ...
        builder: {work: 10, move: 10, carry: 10},
        harvester: {work: 5, move: 1},
        transfer: {carry: 10, move: 5},
        ...
        maintainer: {carry: 16, move: 8},
        controller: {claim: 1, move: 1},
        extender: {work: 15, carry: 15, move: 15}, 
    },
    E3S59: {
        worker: {work: 3, move: 3, carry: 3},
        builder: {work: 3, move: 3, carry: 3},
    },
    test: {
        attacker: {move: 2},
        healer: {move: 2}
